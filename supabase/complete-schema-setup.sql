-- Complete MetX Database Schema Setup
...
-- Create prompts table (if not exists from previous step)
...
-- Update the MetX Layer Generator prompt with the complete version
